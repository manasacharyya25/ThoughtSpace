...
const colourfulInboxSans = Plus_Jakarta_Sans({
  subsets: ["latin"],
...
export default function InboxListLayout({
  ...
  return (
    <div
      className={`${colourfulInboxSans.variable} relative -mx-4 -mt-4 min-h-full w-[calc(100%+2rem)] bg-[#FAF8F5] px-4 pb-2 pt-4 sm:-mx-6 sm:w-[calc(100%+3rem)] sm:px-6 md:-mt-6 md:pb-4`}
    >
      <div
