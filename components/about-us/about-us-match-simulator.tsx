...
export function AboutUsMatchSimulator() {
              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <textarea
                    ...
                    className={cn(
                      "about-us-input w-full rounded-lg p-4 text-sm leading-relaxed",
                  ...
                  <div className="flex flex-col gap-2">
                    {sampleThoughts.map((sample) => (
                      <button
                        ...
                        className="about-us-quick-prompt w-full rounded-lg p-3 text-left text-xs"
                      >
                        &ldquo;{sample}&rdquo;
                      </button>
                    ))}
                ...
                <button
                  type="button"
                  onClick={startMatch}
                  className="about-us-btn-primary w-full rounded-lg py-4 font-landing-mono text-xs uppercase tracking-wider"
                >
                    ...
                    >
                      ...
                      <div
                        className={cn(
                          ...
                          msg.isUser
                            ? "ml-auto rounded-tr-none bg-about-us-input"
