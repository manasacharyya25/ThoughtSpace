            ...
            <div className="mx-auto max-w-2xl space-y-8">
              <div className="space-y-4 rounded-xl border border-landing-border bg-[#0a0a09] p-6">
                ...
                <textarea
                  ...
                  className="landing-input w-full rounded-lg p-4 text-sm leading-relaxed"
          ...
          <div className="w-full max-w-md space-y-6 rounded-xl border border-landing-border bg-[#0a0a09] p-6 shadow-2xl">
            ...
            <div className="space-y-2">
              ...
              <textarea
                ...
                className="landing-input w-full rounded-lg p-3 text-sm"
            ...
            <button
              ...
              className="landing-btn-primary w-full rounded py-3 font-landing-mono text-xs font-bold uppercase tracking-wider"
            >
              Transmit Response
            </button>
          </div>
